...
public abstract class AbstractWheel extends View {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mVisibleItems = a.getInt( at.gepa.bloodpreasure.R.styleable.AbstractWheelView_visibleItems, DEF_VISIBLE_ITEMS);
        mIsAllVisible = a.getBoolean(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_isAllVisible, false);
        mIsCyclic = a.getBoolean(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_isCyclic, DEF_IS_CYCLIC);
