...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, at.gepa.bloodpreasure.R.styleable.AbstractWheelView, defStyle, 0);
        mItemsDimmedAlpha = a.getInt(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_itemsDimmedAlpha, DEF_ITEMS_DIMMED_ALPHA);
        mSelectionDividerActiveAlpha = a.getInt(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_selectionDividerActiveAlpha, DEF_SELECTION_DIVIDER_ACTIVE_ALPHA);
        mSelectionDividerDimmedAlpha = a.getInt(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_selectionDividerDimmedAlpha, DEF_SELECTION_DIVIDER_DIMMED_ALPHA);
        mItemOffsetPercent = a.getInt(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_itemOffsetPercent, DEF_ITEM_OFFSET_PERCENT);
        mItemsPadding = a.getDimensionPixelSize(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_itemsPadding, DEF_ITEM_PADDING);
        mSelectionDivider = a.getDrawable(at.gepa.bloodpreasure.R.styleable.AbstractWheelView_selectionDivider);
        a.recycle();
    }
