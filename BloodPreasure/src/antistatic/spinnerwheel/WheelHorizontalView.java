...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    public WheelHorizontalView(Context context, AttributeSet attrs) {
        this(context, attrs, at.gepa.bloodpreasure.R.attr.abstractWheelViewStyle);
    }
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, at.gepa.bloodpreasure.R.styleable.WheelHorizontalView, defStyle, 0);
        mSelectionDividerWidth = a.getDimensionPixelSize(at.gepa.bloodpreasure.R.styleable.WheelHorizontalView_selectionDividerWidth, DEF_SELECTION_DIVIDER_SIZE);
        a.recycle();
    }
