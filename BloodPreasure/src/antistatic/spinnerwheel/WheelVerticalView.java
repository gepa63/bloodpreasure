...
public class WheelVerticalView extends AbstractWheelView {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, at.gepa.bloodpreasure.R.styleable.WheelVerticalView, defStyle, 0);
        mSelectionDividerHeight = a.getDimensionPixelSize(at.gepa.bloodpreasure.R.styleable.WheelVerticalView_selectionDividerHeight, DEF_SELECTION_DIVIDER_SIZE);
        a.recycle();
    }
